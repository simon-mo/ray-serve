from serve.queues import CentralizedQueues
import ray
...
def test_probabilities(serve_instance):
    ...
    backend_1_ready_oids, _ = ray.wait(work_oid_1_s, num_returns=100, timeout=0.0)
    backend_2_ready_oids, _ = ray.wait(work_oid_2_s, num_returns=100, timeout=0.0)
